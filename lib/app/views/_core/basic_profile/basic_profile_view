...
import 'package:digicard/app/extensions/address_extension.dart';
...
class BasicProfileView extends StatelessWidget {
  const BasicProfileView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<BasicProfileViewModel>.reactive(
        viewModelBuilder: () => BasicProfileViewModel(),
...
class _BasicProfileForm extends ViewModelWidget<BasicProfileViewModel> {
                ...
                children: [
                  ...
                  StaggeredGridTile.fit(
                    ...
                    child: Row(
                      children: [
                        EzButton.elevated(
                          busy: viewModel.busy(updateProfile),
                          title: "Save",
                          onTap: () async {
...
class _ProfileCard extends ViewModelWidget<BasicProfileViewModel> {
  const _ProfileCard({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, BasicProfileViewModel viewModel) {
    Widget name() {
      return Text(
