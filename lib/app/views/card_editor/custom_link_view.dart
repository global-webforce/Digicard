                  ...
                  builder: (context, formModel, _) {
                    ...
                    Widget textField() {
                      return ReactiveTextField(
                          ...
                          maxLines:
                              ("${formModel.typeControl?.value}" == "Address")
                                  ? null
                                  : 1,
                          maxLength:
                              ("${formModel.typeControl?.value}" == "Address")
                          ...
                          keyboardType:
                              keyboardType("${formModel.typeControl?.value}"),
                    ...
                    return Column(
                      children: [
                        ...
                        vSpaceRegular,
                        EzButton.elevated(
                          disabled: formModel.textControl?.hasErrors ?? true,
                          title: "SAVE",
                          onTap: () {
